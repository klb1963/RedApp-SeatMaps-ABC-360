...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-sabre-redapp-fundamentals-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-sabre-redapp-fundamentals-web-module/translations');
